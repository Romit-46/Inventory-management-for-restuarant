...
a=[]
database=Databasein("SE_PROJECT/inventory.db")
con = sqlite3.connect("SE_PROJECT/inventory.db")
cur = con.cursor()

def is_valid_password():

    cur.execute("SELECT * FROM manager WHERE id = ? AND password = ?",(user_text.get(),pass_text.get(),))
    result = cur.fetchall()
    a= result
    e1.delete(0,END)
    e2.delete(0,END)
    ...
    if not result:
        messagebox.showwarning("showwarning", "Inavalid input")
    else:
        manager()
...
def manager():
    ...
    imagetest = PhotoImage(file="SE_PROJECT/backbutton.png")
    imagetest=imagetest.subsample(6,6)
    searchi = PhotoImage(file="SE_PROJECT/search1.png")
    searchi=searchi.subsample(12,12)
    viewi = PhotoImage(file="SE_PROJECT/view3.png")
    viewi=viewi.subsample(14,14)
    deletei = PhotoImage(file="SE_PROJECT/delete.png")
    ...
    def addrecipe():
        ...
        def addrec_command():
            ...
            messagebox.showinfo("showinfo", "Added successfully",parent=ar)
        ...
        def addmenu():
            if len(e2.get()) == 0:
                messagebox.showwarning("showwarning", "Null input",parent=ar)
            else:
                cur.execute("INSERT INTO menu_items VALUES (?,?,?)",(item_name.get(),price_menu.get(),id.get()))
                list1.delete(0,END)
                list1.insert(END,(item_name.get(),price_menu.get(),id.get()))
                e1.delete(0,END)
                e2.delete(0,END)
                e3.delete(0,END)
                messagebox.showinfo("showinfo", "Added successfully",parent=ar)
        ...
        def searchmenu():
            list1.delete(0,END)
            cur.execute("SELECT * FROM menu_items WHERE item_name=?", (item_name.get(),))
            rows=cur.fetchall()
            for row in rows:
                list1.insert(END,row)

        def deletemenu():
            cur.execute("DELETE FROM menu_items WHERE item_name=?",(item_name.get(),))
            e1.delete(0,END)
            e2.delete(0,END)
            e3.delete(0,END)
            con.commit()
        ...
        item_name=StringVar()
        e1=Entry(ar,textvariable=item_name,bg='alice blue')
        e1.grid(row=1,column=1)
        l2=Label(ar,text="PRICE ",bg='azure',fg='DeepPink4',font=("Helvetica", 11))
        l2.grid(row=2,column=0)
        price_menu=StringVar()
        e2=Entry(ar,textvariable=price_menu,bg='alice blue')
        e2.grid(row=2,column=1)
        
        l3=Label(ar,text="UNIQUE ID",bg='azure',fg='DeepPink4',font=("Helvetica", 11))
        l3.grid(row=3,column=0)
        id=IntVar()
        e3=Entry(ar,textvariable=id,bg='alice blue')
        ...
        b1=Button(ar,text="ADD",width=16,font='sans 10 bold',bg='DarkOrange1',fg='white',activebackground="#00ffff",command=addmenu)
        b1.grid(row=7,column=0,padx=10, pady=10)   
        b5=Button(ar,text="VIEW",image=viewi,compound=RIGHT, width=100,font='sans 10 bold',bg='DarkOrange1',fg='white',activebackground="#00ffff",activeforeground="black",command=viewmenu)
        b5.grid(row=7,column=1,padx=10, pady=10)
        b6=Button(ar,text="SEARCH", image=searchi,width=100,compound=RIGHT,font='sans 10 bold',bg='DarkOrange1',fg='white',activebackground="#00ffff",activeforeground="black",command=searchmenu)
    ...
    def updaterecipe():
        ...
        def addmenu():
            cur.execute("INSERT INTO menu_items VALUES (?,?,NULL)",(item_name.get(),price_menu.get()))
            list1.delete(0,END)
            list1.insert(END,(item_name.get(),price_menu.get()))
        ...
        def deletemenu():
            ...
            if(mg=='yes'):
                ...
                e3.delete(0,END)
                viewmenu()
                messagebox.showinfo("showinfo", "Deleted successfully",parent=ur)
                con.commit()
        ...
        def updatemenu():
            if len(e2.get()) == 0:
                messagebox.showwarning("showwarning", "Null input",parent=ur)
            else:
                cur.execute("INSERT OR REPLACE INTO menu_items VALUES (?,?,?)",(item_name.get(),price_menu.get(),id.get()))
                list1.delete(0,END)
                viewafterupdate()
                messagebox.showinfo("showinfo", "Updated successfully",parent=ur)
                con.commit() 
        ...
        l1.grid(row=1,column=0)
        item_name=StringVar()
        e1=Entry(ur,textvariable=item_name,bg='alice blue')
        e1.grid(row=1,column=1)
        l2=Label(ur,text="PRICE",bg='azure',fg='DeepPink4',font=("Helvetica", 11))
        l2.grid(row=2,column=0)
        price_menu=StringVar()
        e2=Entry(ur,textvariable=price_menu,bg='alice blue')
        e2.grid(row=2,column=1)
        l3=Label(ur,text="UNIQUE ID",bg='azure',fg='DeepPink4',font=("Helvetica", 11))
        l3.grid(row=3,column=0)
        id=IntVar()
        e3=Entry(ur,textvariable=id,bg='alice blue')
        e3.grid(row=3,column=1)
        ...
        sb1.configure(bg='black',command=list1.yview)
        list1.bind('<<ListboxSelect>>',get_selected_row)
        b1=Button(ur,text="UPDATE",width=16,font='sans 10 bold',bg='DarkOrange1',fg='white',activebackground="#00ffff",command=updatemenu)
        b1.grid(row=7,column=0,padx=10, pady=10)  
        b5=Button(ur,text="VIEW", image=viewi,compound=RIGHT, width=100,font='sans 10 bold',bg='DarkOrange1',fg='white',activebackground="#00ffff",activeforeground="black",command=viewmenu)
        b5.grid(row=7,column=1,padx=10, pady=10)
        b6=Button(ur,text="SEARCH", image=searchi,width=100,compound=RIGHT,font='sans 10 bold',bg='DarkOrange1',fg='white',activebackground="#00ffff",activeforeground="black",command=searchmenu)
        b6.grid(row=7,column=2,padx=10, pady=10)
        b7=Button(ur,text="DELETE", image=deletei,width=100,compound=RIGHT,font='sans 10 bold',bg='firebrick1',fg='white',activebackground="#00ffff",activeforeground="black",command=deletemenu)
    ...
    b3.grid(row=0,column=6,padx=10, pady=10)
...
l0=Label(log,text="*")
l0.grid(row=0,column=1)
l2=Label(log,text="USERNAME")
l2.grid(row=2,column=6)
user_text=StringVar()
e1=Entry(textvariable=user_text,bg='alice blue')
e1.grid(row=2,column=7)
l3=Label(log,text="PASSWORD")
l3.grid(row=3,column=6)
pass_text=StringVar()
e2=Entry(textvariable=pass_text,show='*',bg='alice blue')
e2.grid(row=3,column=7)
l4=Label(log,text="*")
l4.grid(row=7,column=10)

b2=Button(log,text="LOGIN",width=16,activebackground="#00ffff",bg='darkorange',activeforeground="black",command=is_valid_password)
b2.grid(row=4,column=7,padx=10, pady=10)
